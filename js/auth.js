...
const USERS = {
    "admin": {
        ...
        role: "admin",
        name: "Administrador",
        modules: ["contado", "credito_nuevo", "accesorios", "inventario", "simexpress", "existencias", "transferencias", "transferencias_pendientes", "tae", "ventasTotales", "servicios", "ingresos", "credito", "compras", "facturas", "analisis_margen","tae_apps","inventarioAccesorios","boletos_erp","resumenGeneral","inventarioSucursal","servipremia"],
        showTaeBalance: true
    },
    "comercial": {
